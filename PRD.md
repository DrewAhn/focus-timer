...
[Reset 클릭] → 현재 모드의 초기 시간으로 복귀
     ↓
[시간 종료] → 종소리 알림 🔔 + 타이머 흔들림 + 진동(모바일)
     ↓
[사운드 OFF] → 타이머 흔들림 + 진동(모바일)만 실행
```
...
3. **40분 후** 타이머 종료 → 종소리 🔔 + 타이머 흔들림 + 완료 메시지
4. Break 탭 클릭 → Break 모드 (**10:00**) 전환
5. [Start] 클릭 → 휴식 타이머 시작, 탭에 "10:00 - Break Timer" 표시
6. **10분 후** 타이머 종료 → 종소리 🔔 + 타이머 흔들림 + 완료 메시지
